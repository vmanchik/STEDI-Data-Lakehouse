...
customer_curated_node1734343671582 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="customer_curated", transformation_ctx="customer_curated_node1734343671582")

# Script generated for node accelerometer_trusted
accelerometer_trusted_node1734341296121 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="accelerometer_trusted", transformation_ctx="accelerometer_trusted_node1734341296121")
...
and customer_curated.email = accelerometer_trusted.user
'''
SQLQuery_node1734341355821 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"accelerometer_trusted":accelerometer_trusted_node1734341296121, "step_trainer_landing":step_trainer_landing_node1734341260287, "customer_curated":customer_curated_node1734343671582}, transformation_ctx = "SQLQuery_node1734341355821")
